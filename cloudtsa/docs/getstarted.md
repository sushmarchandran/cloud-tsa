...
```
**In your CloudTSA dashboard in Grafana,** continue with the same variable specifications and you will see the graphs from part 1 getting updated as in the following animation over a period of *3 min*.
