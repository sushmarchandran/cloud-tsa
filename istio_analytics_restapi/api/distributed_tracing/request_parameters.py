...
####
# Schema of the request-body parameters for POST /distributed_tracing/traces/ 
# to retrieve a summary of traces
####
trace_summary_body_parameters = api.model('trace_summary_params', {
