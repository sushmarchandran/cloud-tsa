        ...
        .each(function (d) {
            ...
            d3.select(this)
                .on("mouseenter", function(d2) {
                    ...
                    t.append("tspan").attr("x", 0).attr("dy", "1.2em").text(prettyMicroseconds(d.baseline_stats.duration.min, d.baseline_stats.duration.max))
                    t.append("tspan").attr("x", 50).text(prettyMicroseconds(d.baseline_stats.duration.first_quartile, d.baseline_stats.duration.max))
                    t.append("tspan").attr("x", 100).text(prettyMicroseconds(d.baseline_stats.duration.median, d.baseline_stats.duration.max))
                    t.append("tspan").attr("x", 150).text(prettyMicroseconds(d.baseline_stats.duration.third_quartile, d.baseline_stats.duration.max))
                    ...
                    t.append("tspan").style("font-weight", "bold").attr("x", 150).text("Q3")
                    t.append("tspan").style("font-weight", "bold").attr("x", 200).text("Max")
                    t.append("tspan").attr("x", 0).attr("dy", "1.2em").text(prettyMicroseconds(d.canary_stats.duration.min, d.canary_stats.duration.max))
                    t.append("tspan").attr("x", 50).text(prettyMicroseconds(d.canary_stats.duration.first_quartile, d.canary_stats.duration.max))
                    t.append("tspan").attr("x", 100).text(prettyMicroseconds(d.canary_stats.duration.median, d.canary_stats.duration.max))
                    t.append("tspan").attr("x", 150).text(prettyMicroseconds(d.canary_stats.duration.third_quartile, d.canary_stats.duration.max))
        ...
        .each(function (d) {
            ...
            d3.select(this)
                .on("mouseenter", function(d2) {
                    ...
                    t.append("tspan").style("font-weight", "bold").attr("x", 150).text("Q3")
                    t.append("tspan").style("font-weight", "bold").attr("x", 200).text("Max")
                    t.append("tspan").attr("x", 0).attr("dy", "1.2em").text(prettyMicroseconds(d.baseline_stats.duration.min, d.canary_stats.duration.max))
                    t.append("tspan").attr("x", 50).text(prettyMicroseconds(d.baseline_stats.duration.first_quartile, d.baseline_stats.duration.max))
                    t.append("tspan").attr("x", 100).text(prettyMicroseconds(d.baseline_stats.duration.median, d.canary_stats.duration.max))
                    t.append("tspan").attr("x", 150).text(prettyMicroseconds(d.baseline_stats.duration.third_quartile, d.baseline_stats.duration.max))
                    t.append("tspan").attr("x", 200).text(prettyMicroseconds(d.baseline_stats.duration.max))
                    t.append("tspan").attr("x", 0).attr("dy", "1.2em").text("vs")
                    t.append("tspan").style("font-weight", "bold").attr("x", 0).attr("dy", "1.2em").text("Min")
